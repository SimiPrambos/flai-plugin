---
name: flai-sdk-upgrade
description: >
  Reference for bumping Dart and Flutter SDK constraints across packages.
  Use when upgrading the Flutter or Dart SDK version in any repository — bumping
...
# Flutter/Dart SDK Upgrade — Quick Reference
...
For **pure Dart packages**, use the Dart SDK directly:

```yaml
- uses: dart-lang/setup-dart@v1
  with:
    sdk: '^3.5.x'  # Dart version
```
...
```text
chore: bump Flutter to 3.24.0 / Dart to 3.5.0

- Update flutter-version in .github/workflows/ to ^3.24.x (CI resolves latest patch)
